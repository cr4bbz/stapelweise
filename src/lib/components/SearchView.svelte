          ...
          >
            <div class="flex-1 min-w-0 grid grid-cols-2 gap-4">
              <div>
                ...
                <p class="font-card text-primary dark:text-primary-dark mt-0.5 line-clamp-2">{@html renderMarkdown(result.card.front)}</p>
              </div>
              <div>
                <span class="text-xs font-medium text-secondary uppercase tracking-wide">Antwort</span>
                <p class="font-card text-primary dark:text-primary-dark mt-0.5 line-clamp-2">{@html renderMarkdown(result.card.back)}</p>
              </div>
            </div>
